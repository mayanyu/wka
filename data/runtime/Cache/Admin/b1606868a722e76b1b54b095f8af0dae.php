			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						<td align="center"><a target="_blank" href="/<?php echo ($vo["uid"]); ?>"><?php echo ($vo["uid"]); ?></a></td>					
						...
						<?php if($vo['isvideo']==1): ?><td><?php echo ($vo['pull']); ?></td>
						<td>
						...
						<?php else: ?>
						<td><?php echo PrivateKeyA('rtmp',$vo['stream'],0);?></td>
						<td>
						</td><?php endif; ?>
