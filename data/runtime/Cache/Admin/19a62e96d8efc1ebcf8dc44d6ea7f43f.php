		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Config/set_post');?>">
			...
			<div class="js-tabs-content">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="post[site_icp]"><?php echo ($config['site_icp']); ?></textarea>备案信息（200字以内）
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">地址</label>
							<div class="controls">
								<textarea name="post[site_addr]"><?php echo ($config['site_addr']); ?></textarea>地址信息（200字以内）
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">电话</label>
							<div class="controls">
								<textarea name="post[site_telephone]"><?php echo ($config['site_telephone']); ?></textarea>电话信息（200字以内）
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">邮箱</label>
							<div class="controls">
								<textarea name="post[site_email]"><?php echo ($config['site_email']); ?></textarea>邮箱信息（200字以内）
							</div>
						</div>
						<div class="control-group">
				...
				<div>
					<fieldset>
						<div class="control-group">
							<label class="control-label">才艺直播</label>
							<div class="controls">
								<input type="text" name="post[live_show]" value="<?php echo ($config['live_show']); ?>">请填写用户ID,多个ID之间使用英文“,”分割
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">才艺直播时间</label>
							<div class="controls">
								<input type="text" name="post[live_show_time]" value="<?php echo ($config['live_show_time']); ?>">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">才艺回放</label>
							<div class="controls">
								<input type="text" name="post[live_record]" value="<?php echo ($config['live_record']); ?>">请填写用户ID,多个ID之间使用英文“,”分割
							</div>
						</div>
					</fieldset>
				</div>
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="post[ios_shelves]" value="<?php echo ($config['ios_shelves']); ?>">
