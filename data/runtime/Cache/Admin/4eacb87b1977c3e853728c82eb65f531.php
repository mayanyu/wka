...
<body>
	<div class="wrap">
		...
		<?php $type=array("income"=>"收入","expend"=>"支出"); $action=array("sendgift"=>"赠送礼物","sendbarrage"=>"弹幕","loginbonus"=>"登录奖励","buyvip"=>"购买VIP","buycar"=>"购买坐骑","buyliang"=>"购买靓号","sharereward"=>"分享奖励",'roomcharge'=>'房间扣费','timecharge'=>'计时扣费','bid_price'=>'竞拍费用','price_bond_return'=>'退还保证金','price_bond'=>'缴纳保证金'); ?>
