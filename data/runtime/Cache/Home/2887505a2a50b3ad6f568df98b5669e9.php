...
<body class="home-live">
<div class="mainBox clearfix">
		<div class="container content">
				<div class="module-title">
						<h2><span>观看热门直播</span><br>Watch the popular live broadcast</h2>
				</div>
				<div class="row m-list">
						<?php if(is_array($live_show)): $i = 0; $__LIST__ = $live_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="col-md-3 m-item <?php if( $v['islive'] == '1'): ?>live live<?php echo ($v['uid']); ?>
										<?php else: ?>
										none-live<?php endif; ?>
										" onclick="window.location.href='./<?php echo ($v['uid']); ?>';">
